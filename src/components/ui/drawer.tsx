...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Overlay
    ref={ref}
    className={cn("fixed inset-0 z-50 bg-white/10 backdrop-blur-sm", className)}
    {...props}
  />
))
...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-x-4 bottom-4 z-50 mx-auto max-w-[361px] overflow-hidden rounded-[36px] bg-card shadow-lg outline-none",
...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Title
    ref={ref}
    className={cn(
      "w-full text-center text-[19px] font-semibold text-gray-200",
      "md:font-medium",
      className,
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Description
    ref={ref}
    className={cn(
      "text-[17px] font-bold leading-[24px] text-gray-200",
      "md:font-normal",
      className,
    )}
    {...props}
