...
export default function LoginPage() {
  return (
    <>
      <div className="mt-20 min-h-full py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
          <div className="bg-card p-6 shadow sm:rounded-lg">
            <div className="grid grid-cols-2 gap-4">
              <a
                aria-disabled="true"
                className="flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 opacity-50 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus-visible:ring-transparent"
              >
